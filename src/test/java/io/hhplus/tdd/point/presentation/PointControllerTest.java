...
class PointControllerTest {
	...
	void givenNegativeId_whenFindPointHistory_thenThrowConstraintViolationException() {
		...
		// when
		ThrowableAssert.ThrowingCallable zeroCase = () -> pointController.point(zeroUserId);
		ThrowableAssert.ThrowingCallable negativeCase = () -> pointController.point(negativeUserId);
